          ...
          <template #actions>
            ...
            >
              <a-tooltip :title="$t('tooltips.collected')">
                <StarTwoTone two-tone-color="#FFD700" style="margin-right: 8px" />
                {{ item.collectNum }}
              </a-tooltip>
            </span>
            ...
            >
              <a-tooltip :title="$t('tooltips.liked')">
                <LikeTwoTone two-tone-color="#FF0000" style="margin-right: 8px" />
                {{ item.likeNum }}
              </a-tooltip>
            </span>
            ...
            <a-tooltip :title="$t('tooltips.hot')">
              <span>
                <FireTwoTone two-tone-color="#FF4500" style="margin-right: 8px" />
                {{ item.hotScore }}
              </span>
            </a-tooltip>
          ...
          <a-list-item-meta :description="item.characterSign">
            ...
            <template #avatar>
              <a-avatar
                ...
                :src="item.avatarUrl"
              />
              <a-avatar v-else :size="64">{{ item.nickName }}</a-avatar>
            </template>
          </a-list-item-meta>
        <el-divider />
          <a-typography-title
